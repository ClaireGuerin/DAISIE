...
#'   without \code{odeint::}-prefix, The default method for CS is:
#'   \code{'odeint::runge_kutta_fehlberg78'}. \code{"lsodes"} from
#'   \code{\link[deSolve]{ode}} method is also available.
